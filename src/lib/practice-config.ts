...
export const practiceTemplates: Record<string, PracticeConfig> = {
  'callen-lorde': {
    id: 'callen-lorde',
    name: 'Callen Lorde Clinic',
    doctor: 'Callen Lorde Clinic Team',
...
export function getCurrentPractice(): PracticeConfig {
  ...
  return practiceTemplates['callen-lorde'];
}